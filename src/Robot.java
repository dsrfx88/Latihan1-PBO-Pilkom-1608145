...
public class Robot {
    ...
    int kesehatan;
    String nama = "";
    ArrayList<Senjata> myArray = new ArrayList<>();         //bonus
    ...
    public void tambahSenjataLagi(Senjata s){
        myArray.add(s);
    }
    ...
    */
    public void serang(Robot rLawan) {
       ...
       rLawan.kesehatan =  (rLawan.kesehatan - oSenjata.kekuatan) + oPerisai.skorKekuatan;          //nomor 5
    }
}
